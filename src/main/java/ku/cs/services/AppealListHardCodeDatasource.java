...
//        appealList.addNewAppeal(new Appeal(DateTimeService.detailedDateToString(new Date()),"คำร้องขอพักการศึกษา", "ใบคำร้องใหม่ | คำร้องส่งต่อให้อาจารย์ที่ปรึกษา", "6610401985","Aock taepun", "เกรดเฉลี่ยน้อยเกินไป", "เทอมปลาย", "2567", "112,234,A PLUS PLUS", UUID.randomUUID().toString()));
        ...
        appealList.addAppeal(new GeneralAppeal(modifyDate, UUID.randomUUID().toString(), "คำร้องทั่วไป", newAppealStatus, "6610401934", "Ton KerdSiri", "อาจารย์เคยกินข้าวแกงกะหรี่ฝีมือผมมั้ยยย?? ผมอยากให้อาจารย์ลองสักครั้ง มันอร่อยนะครับ", "อือออ ผมว่าข้าวแกงกะหรี่ฝีมือผมก็ไม่แย่นะ"));
        appealList.addAppeal(new SuspendAppeal(modifyDate, UUID.randomUUID().toString(), "คำร้องขอพักการศึกษา", newAppealStatus, "6610402132", "Bright Bowornrat", "เกิดมา 19 ปียังไม่เคยออกไปทำงานหาเงินด้วยตัวเองเลย ผมขอออกไปหาประสบการณ์เป็นเวลา 1 ปี", "01418211-Software Construction-1/01418235-UNIX-and-OS-2", "ภาคต้น", "2566"));
        appealList.addAppeal(new BreakAppeal(modifyDate, UUID.randomUUID().toString(), "คำร้องขอลาป่วยหรือลากิจ", newAppealStatus, "6610401985", "Aock Chaiyawat", "แค่ก แค่ก รู้สึกเหมือนจะไม่สบาย ปวดหัว ตัวร้อน ไปหมด ผมว่าผมอาจจะเป็นโควิด", "01418262-Machine Learning System-1/01418231-Data Structure-1", "ลาป่วย", "2024/09/20", "2024/09/23"));
        return appealList;
    }
