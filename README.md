...
3. คนที่สาม ต้องห้ามตัวเอง (ทรี)
    ...
    * อธิบายสิ่งที่เป็นประโยชน์ต่อระบบ และทำให้ทีมภูมิใจ ไม่จำกัดจำนวนข้อย่อย
4. 6610405824 คมชาญ วงศ์ศิริสมพงษ์ (กานต์)
    * เพิ่มส่วนของการเปลี่ยน font ในหน้า program setting ให้สามารถเปลี่ยน font ได้ทั้งโปรแกรม
    * ทำข้อมูลเริ่มต้นในการทดสอบโปรแกรม เสมือนว่าโปรแกรมถูกใช้งานมาประมาณ 3 เดือน
    * แก้ไขตารางคำร้องของเจ้าหน้าที่คณะให้แสดงเฉพาะคณะที่เกี่ยวข้อง และแก้บัค
    * ทำ Document ในส่วนของ การเข้าใช้งานระบบของเจ้าที่คณะ และระบบต่างๆ ของเจ้าที่คณะ
    * ทำ Document ในส่วนของการจัดารบัญชีและการตั้งค่าภายในระบบ
